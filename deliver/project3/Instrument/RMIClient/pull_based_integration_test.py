...
class TestPeerToPeerMethods(unittest.TestCase):
    ...
    def test_a_new_file_gets_added_single_gnutella_from_pa1(self):
        ...
        print('10. [Executed RETRIEVE AS Gnutella 2, Server 3 output:', out, ']') 
        ...
        print('Sleep for 3 seconds to give enough time for the poller to catch up.')
        sleep(3);
